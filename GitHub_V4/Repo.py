class Repo:
  ...
  def get_full_org_repos(self, org, repo_after = '', repo_count = 100):
    ...
    '''.format(org_name = org, repo_cursor = repo_after)
    return query
  ...
  def get_repo_base_info(self):
    ...
    '''.format(
      ...
      collaborators = self.part_users_min('collaborators'), forks = self.part_repo_forks(),
      issues = self.part_issues(), labels = self.part_label('labels'),
      languages = self.part_languages(), milestones = self.part_milestones(),
      projects = self.part_projects(), pull_requests = self.part_pull_requests(),
      releases = self.part_releases(),
      repository_topics = self.part_repository_topics(), stargazers = self.part_users_count('stargazers'),
  ...
  def part_users_min(self, shifty_name, user_last = ''):
    ...
    '''.format(connector_name = shifty_name, user_cursor = user_last)
    return query
  ...
  def part_repo_forks(self, forks_last = ''):
    ...
    '''.format(forks_cursor = forks_last)
    return query
  ...
  def part_issue_comments(self, shifty_name, comments_last = ''):
    ...
    '''.format(connection_name = shifty_name, comments_cursor = comments_last)
    return query
  ...
  def part_issues(self, issues_last = ''):
    ...
    '''.format(issues_cursor = issues_last, assignees = self.part_users_min('assignees'),
          comments = self.part_issue_comments('comments'), labels = self.part_label('labels'),
  ...
  def part_label(self, shifty_name, labels_last = ''):
    ...
    '''.format(connection_name = shifty_name, labels_cursor = labels_last)
    return query
  ...
  def part_languages(self, languages_last = ''):
    ...
    '''.format(languages_cursor = languages_last)
    return query
  ...
  def part_milestones(self, with_issues = False, milestones_last = ''):
    ...
    '''.format(issues = issue_connector, milestones_cursor = milestones_last)
    return query
  ...
  def part_columns(self, columns_last = ''):
    ...
    '''.format(columns_cursor = columns_last)
    return query
  ...
  def part_pending_cards(self, pending_cards_last = ''):
    ...
    '''.format(pending_cards_cursor = pending_cards_last)
    return query
  ...
  def part_projects(self, projects_last = ''):
    ...
    '''.format(
                columns = self.part_columns(), pending_cards = self.part_pending_cards(),
  ...
  def part_files(self, files_last = ''):
    ...
    '''.format(files_cursor = files_last)
    return query
  ...
  def part_reviews(self, reviews_last = ''):
    ...
    '''.format(reviews_cursor = reviews_last)
    return query
  ...
  def part_pull_request_commit(self, commits_last = ''):
    ...
    '''.format(commits_cursor = commits_last)
    return query
  ...
  def part_pull_requests(self, pull_requests_last = ''):
    ...
    '''.format(
                comments = self.part_issue_comments('comments'), commits = self.part_pull_request_commit(),
                files = self.part_files(), participants = self.part_users_min('participants'),
                pull_requests_cursor = pull_requests_last, reviews = self.part_reviews()
              )
    return query
  ...
  def part_release_assets(self, release_assets_last = ''):
    ...
    '''.format(release_assets_cursor = release_assets_last)
    return query
  ...
  def part_releases(self, releases_last = ''):
    ...
    '''.format(releases_cursor = releases_last, release_assets = self.part_release_assets())
    return query
  ...
  def part_repository_topics(self, repository_topics_last = ''):
    ...
    '''.format(repository_topics_cursor = repository_topics_last)
    return query
  ...
  def part_repo_deploy_keys(self, deploy_keys_last = ''):
    ...
    '''.format(deploy_keys_cursor = deploy_keys_last)
    return query
  ...
  def part_reaction(self, shifty_name, reaction_last = ''):
    ...
    '''.format(connection_name = shifty_name, reaction_cursor = reaction_last, user = self.part_users_min('user'))
    return query
